...
base = '/opt/data/nexury-site-bem-mais-bella/public/artigos/moda-inclusiva-2026'
...
# Each entry: (color, label, subtitle)
entries = [
    ((36,0,70), "MODA INCLUSIVA 2026", "ESTILO PARA TODOS OS CORPOS"),
    ((247,37,133), "ESTILO TAILORED PLUS", "CORTES PERFEITOS PARA VOCE"),
    ((85,135,245), "ABORDAGEM HOLISTICA", "CONFIANCA E AUTOEXPRESSAO"),
    ((50,150,100), "TECIDOS INOVADORES", "CONFORTO E SUSTENTABILIDADE"),
    ((255,140,0), "DETOX DIGITAL", "AUTENTICIDADE REAL"),
    ((106,90,205), "ADEQUACAO E AMOR PROPRIO", "VOCE E O PADRAO"),
]
