#!/usr/bin/env python3
"""Gera imagens WebP para os artigos autocuidado-consciente e moda-consciente."""
...
gen(f'{BASE}/autocuidado-consciente-hype-2026',
    [(36,0,70), (247,37,133), (245,245,250), (235,230,220), (84,89,95), (255,165,0)],
    [
        ('AUTOCUIDADO', 'CONSCIENTE 2026'),
        ('MINDFULNESS', 'PAZ INTERIOR'),
        ('CORPO EM PAZ', 'MENTE CLARA'),
        ('ENERGIA', 'CURAR E CUIDAR'),
        ('BEM ESTAR', 'HÁBITOS SAUDÁVEIS'),
        ('AMOR PRÓPRIO', 'VALORIZAR-SE'),
    ])

# === MODA CONSCIENTE ===
gen(f'{BASE}/moda-consciente-respeita-corpo-planeta-2026',
    [(36,0,70), (247,37,133), (245,245,250), (235,230,220), (84,89,95), (255,165,0)],
    [
        ('MODA CONSCIENTE', 'RESPEITO AO CORPO'),
        ('ESTILO ÉTICO', 'SUSTENTABILIDADE'),
        ('GUARDA-ROUPA', 'QUE DURA'),
        ('INCLUSÃO', 'TODOS OS CORPOS'),
        ('MATERIAIS', 'ECOLOGICOS'),
        ('PROPÓSITO', 'NA MODA'),
    ])

print('\nAll images created for both articles!')
