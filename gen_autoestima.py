...
base = '/workspace/nexury-site-bem-mais-bella/public/artigos/hype-autoestima-2026'
...
entries = [
    ((36,0,70), "AUTOESTIMA HYPE 2026", "RECONSTRUICAO DIARIA"),
    ((247,37,133), "AUTOESTIMA", "MULHER BRASILEIRA"),
    ((85,135,245), "RECONSTRUIR", "TODOS OS DIAS"),
    ((50,150,100), "MODA CONSCIENTE", "RESISTENCIA"),
    ((255,140,0), "COMUNIDADE", "APOIO MUTUO"),
    ((106,90,205), "IDENTIDADE", "AUTENTICA"),
]
