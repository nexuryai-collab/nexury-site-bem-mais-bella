...
# Article 1: Beleza Biotec
gen_artigo_imgs(
    '/workspace/nexury-site-bem-mais-bella/public/artigos/beleza-biotec-2026-ciencia-skincare',
    [(36,0,70), (247,37,133), (245,245,250), (235,230,220), (84,89,95), (255,165,0)],
    [
        ('BELEZA BIOTEC', 'CIENCIA E SKINCARE'),
        ('PDRN', 'REGENERACAO CUTANEA'),
        ('LUZ INFRAVELLA', 'BEBEDOURO MENTAL'),
        ('BIOTECNOLUGIA', 'INTEGRACAO COM SAUDE'),
        ('PROXIMIDADE CUTANEA', 'AUTENTICIDADE'),
        ('FUTURO DA BELEZA', 'INOVACAO NATURAL')
    ]
)

# Article 2: Sono da Beleza
gen_artigo_imgs(
    '/workspace/nexury-site-bem-mais-bella/public/artigos/sono-da-beleza-2026-ritual-noturno',
    [(36,0,70), (247,37,133), (245,245,250), (235,230,220), (84,89,95), (255,165,0)],
    [
        ('SONO DA BELEZA', 'RECUPERACAO FEMININA'),
        ('DESCANSO ATIVO', 'RESISTENCIA'),
        ('HIGIENE DO SONO', 'ROTINA SAUDAVEL'),
        ('CIRCADIANO', 'BIOLOGIA FEMININA'),
        ('BURNOUT', 'EXAUSTAO'),
        ('RECUPERACAO', 'BIEN ESTAR')
    ]
)
