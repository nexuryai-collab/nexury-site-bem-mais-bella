...
base = '/workspace/nexury-site-bem-mais-bella/public/artigos/brazilcore-beauty-hype-2026'
...
for i, (color, (label, sub), fn_name) in enumerate(zip(colors, labels, ['hero'] + [f'sec{i}' for i in range(1, 6)])):
