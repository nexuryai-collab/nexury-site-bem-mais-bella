...
# Artigo 1: autoconhecimento-jornada-2026
gen_artigo_imgs(
    '/workspace/nexury-site-bem-mais-bella/public/images/artigos/autoconhecimento-jornada-2026',
    [(36,0,70), (106,90,205), (245,245,250), (84,89,95), (247,37,133), (50,150,100)],
    [
        ('JOURNALING 2026', 'AUTOCONHECIMENTO EM EVOLUCAO'),
        ('DIARIO DE SENTIMENTOS', 'EMOCAO E CONSCIENCIA'),
        ('PLANNER DE OBJETIVOS', 'METAS E HABITOS'),
        ('DIARIO DE GRATIDAO', 'BEM ESTAR EMOCIONAL'),
        ('JOURNALING DIGITAL', 'TECNOLOGIA E AUTOCONHECIMENTO'),
        ('AUTOCONHECIMENTO COLETIVO', 'COMUNIDADE E CURA'),
    ]
)

# Artigo 2: artesanato-espiritual-2026
gen_artigo_imgs(
    '/workspace/nexury-site-bem-mais-bella/public/images/artigos/artesanato-espiritual-2026',
    [(36,0,70), (247,37,133), (245,245,250), (235,230,220), (84,89,95), (255,165,0)],
    [
        ('ARTESANATO 2026', 'CURA MANUAL E ESPIRITUALIDADE'),
        ('TECELAGEM', 'FIO E MEDITACAO'),
        ('ARGILA', 'MODELAGEM TERAPUTICA'),
        ('BATIK NATURAL', 'PIGMENTOS DE PLANTAS'),
        ('MANDALAS', 'ESTABILIDADE E PAZ'),
        ('COMUNIDADE ARTESANAL', 'CIRCULO DE CURA'),
    ]
)
