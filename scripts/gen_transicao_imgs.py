...
base = 'public/artigos/transicao-carreira-mulheres-2026'
os.makedirs(base, exist_ok=True)

colors = [(36,0,70), (247,37,133), (245,245,250), (235,230,220), (84,89,95), (255,165,0)]
labels = [
    ('TRANSICAO DE CARREIRA', 'REINVENTE SUA PROFISSAO'),
    ('MULHERES EM TRANSICAO', 'CORAGEM E PROPOSITO'),
    ('HABILIDADES TRANSFERIVEIS', 'APROVEITE SEU CAPITAL'),
    ('PLANEJAMENTO ESTRATEGICO', 'SEGURANCA NA MUDANCA'),
    ('NETWORKING COM PROPOSITO', 'RELACIONAMENTOS GENUINOS'),
    ('SEU PROXIMO PASSO', 'A CARREIRA DOS SEUS SONHOS')
]
