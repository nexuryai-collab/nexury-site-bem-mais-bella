...
# Brazilcore Beauty Hype 2026
gen_artigo_imgs(
    '/workspace/nexury-site-bem-mais-bella/public/images/artigos/brazilcore-beauty-hype-2026',
    [(36,0,70), (247,37,133), (245,245,250), (235,230,220), (84,89,95), (255,165,0)],
    [
        ('BRAZILCORE BEAUTY', 'O HYPE BRASILEIRO MUNDIAL'),
        ('CORES TROPICAIS', 'AMARELO VERDE ROSA'),
        ('INGREDIENTES NATURAIS', 'ACAI MARACUJA DENDE'),
        ('MODA GLOBAL', 'PASSARELA E RUA'),
        ('CONSUMO CONSCIENTE', 'ETICA E ESTILO'),
        ('REPRESENTATIVIDADE', 'BELEZA PARA TODAS'),
    ]
)
