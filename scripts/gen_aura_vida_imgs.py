...
# Aura Farming Autenticidade 2026
gen_artigo_imgs(
    '/workspace/nexury-site-bem-mais-bella/public/artigos/aura-farming-autenticidade-2026',
    [(36,0,70), (247,37,133), (245,245,250), (235,230,220), (84,89,95), (255,165,0)],
    [
        ('AURA FARMING 2026', 'Confiança Autêntica'),
        ('CULTIVO DE PRESENÇA', 'Mulher Brasileira'),
        ('ESTILO AUTÊNTICO', 'Moda Consciente'),
        ('BELEZA REAL', 'Ritual de Autocuidado'),
        ('AUTOCUIDADO', 'Fundamento da Aura'),
        ('COMUNIDADE', 'Mulheres Celebrando'),
    ]
)

# Vida Lenta Brasil 2026
gen_artigo_imgs(
    '/workspace/nexury-site-bem-mais-bella/public/artigos/vida-lenta-brasil-2026',
    [(235,230,220), (139,119,101), (200,185,170), (160,140,120), (100,90,80), (180,160,140)],
    [
        ('VIDA LENTA 2026', 'Slow Living Brasil'),
        ('DEACELERAÇÃO', 'Mulher Brasileira'),
        ('SIMPLICIDADE', 'Guarda-Roupa Consciente'),
        ('ALIMENTAR', 'Ritual de Comer'),
        ('NATUREZA', 'Conexão com o Mundo'),
        ('PRESENÇA', 'Relações Humanas'),
    ]
)
