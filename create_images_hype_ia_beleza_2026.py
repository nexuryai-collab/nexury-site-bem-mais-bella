...
os.makedirs('/opt/data/nexury-site-bem-mais-bella/public/images/hype-ia-beleza-2026', exist_ok=True)
...
hero.save('/opt/data/nexury-site-bem-mais-bella/public/images/hype-ia-beleza-2026/hero.webp', 'WEBP')
...
sec1.save('/opt/data/nexury-site-bem-mais-bella/public/images/hype-ia-beleza-2026/sec1.webp', 'WEBP')

# Section 2 - App de IA
sec2 = create_image(1200, 600, (80, 180, 120), "Apps de Beleza com IA\nRecomendações Personalizadas", (255, 255, 255))
sec2.save('/opt/data/nexury-site-bem-mais-bella/public/images/hype-ia-beleza-2026/sec2.webp', 'WEBP')
...
sec3.save('/opt/data/nexury-site-bem-mais-bella/public/images/hype-ia-beleza-2026/sec3.webp', 'WEBP')
...
sec4.save('/opt/data/nexury-site-bem-mais-bella/public/images/hype-ia-beleza-2026/sec4.webp', 'WEBP')
...
sec5.save('/opt/data/nexury-site-bem-mais-bella/public/images/hype-ia-beleza-2026/sec5.webp', 'WEBP')

# Section 6 - Confiança
sec6 = create_image(1200, 600, (160, 60, 100), "Confiança e Autenticidade\nA Nova Beleza Brasileira", (255, 255, 255))
sec6.save('/opt/data/nexury-site-bem-mais-bella/public/images/hype-ia-beleza-2026/sec6.webp', 'WEBP')
