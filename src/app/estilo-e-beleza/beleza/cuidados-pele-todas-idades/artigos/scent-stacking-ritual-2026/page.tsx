...
export default function Page() {
  return (
    <main className="min-h-screen bg-[#0f051a] text-[#f5f0e6] px-8 py-20 max-w-3xl mx-auto">
      ...
      <h1 className="font-[family-name:var(--font-cormorant)] text-5xl text-[#f5f0e6] mb-6">Scent Stacking: Como Criar Seu Perfume Único com Camadas de Fragrância em 2026</h1>
